...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const APIKEY = "65960cc168a96b6280856773";
  getContacts();
  ...
  document.getElementById("contact-submit").addEventListener("click", function (e) {
    ...
    fetch("https://interactivedev-c188.restdb.io/rest/contact", settings)
  ...
  function updateForm(id, contactName, contactEmail, contactMsg, contactMentor, contactClass) {
    ...
    fetch(`https://interactivedev-c188.restdb.io/rest/contact/${id}`, settings)
      .then(response => response.json())
      .then(data => {
        console.log(data);
        document.getElementById("update-contact-container").style.display = "none";
